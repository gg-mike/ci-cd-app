...
// @Router   /users [get]
func allUsers(dao dao.DAO[model.User, model.User]) gin.HandlerFunc { return dao.GetMany }
...
// @Router   /users [post]
func createUser(dao dao.DAO[model.User, model.User]) gin.HandlerFunc { return dao.Create }
...
// @Failure  500 {object} util.Message "Database error"
// @Router   /users/{id} [get]
func getUser(dao dao.DAO[model.User, model.User]) gin.HandlerFunc { return dao.GetOne }
...
// @Failure  501 {object} util.Message "Endpoint not implemented"
// @Router   /users/{id} [put]
func updateUser(dao dao.DAO[model.User, model.User]) gin.HandlerFunc { return dao.Update }
...
func deleteUser(dao dao.DAO[model.User, model.User]) gin.HandlerFunc { return dao.Delete }
